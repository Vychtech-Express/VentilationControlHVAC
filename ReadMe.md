...
#### Объемы доработок (вступительная часть):
 ...
 - Написать серверную компоненту опроса щитов по их адресам и раздаче опрошенных данных на формочки по их запросам, индикатор которой вывести например в индикаторы на панели задач,
